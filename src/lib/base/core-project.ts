//#region imports
import { _, path, Helpers, crossPlatformPath } from 'tnp-core/src';
import { CLASS } from 'typescript-class-helpers/src';

import { HelpersTaon, LibrariesBuildOptions, TestBuildOptions } from '../index';
...
export const CoreTypescriptProject = CoreProject.from<BaseProject>({
  ...
  async startCommand({ project }) {
    ...
    const mainFilePath = HelpersTaon.getValueFromJSON(
